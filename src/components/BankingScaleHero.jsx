...
const generateDataPoints = () => {
  ...
  for (let i = 0; i < 50; i++) {
    const direction = i % 2 === 0 ? 'down' : 'top';
      ...
      <div className="mx-auto max-w-7xl px-8 py-24 pt-16">
        <div className="grid grid-cols-12 gap-5 gap-y-16">
          ...
          <div className="col-span-12 md:col-span-6">
            <div className="relative w-full h-104 -ml-50">
              <div className="absolute top-0 left-75.5 w-170 h-104 pointer-events-none">
          ...
          <div className="col-span-12">
            <div className="overflow-visible pb-5 mt-4">
